...
class Evaler:
    ...
    def load_img(self, input_dir, input_file, img_ext='png', idx=None):
        ...
        if self.opt.dataset == 'drivingstereo_eigen':
            ...
            gt_noc_fn = os.path.join('dataset/Kitti/kitti_raw_data_flow/flow_gt/'+input_file+"_10."+img_ext)
            gt_noc_flow = fl.read_flow(gt_noc_fn)
            gt_occ_flow = gt_noc_flow.copy()

            return tensorImg1, tensorImg2, gt_noc_flow, gt_occ_flow
        else:
            gt_noc_fn = os.path.join('dataset/Kitti/data_scene_flow/training/flow_noc/'+input_file+"_10."+img_ext)
            gt_occ_fn = os.path.join('dataset/Kitti/data_scene_flow/training/flow_occ/'+input_file+"_10."+img_ext)
...
if __name__ == '__main__':
    ...
    if opts.dataset == 'drivingstereo_eigen':
        ...
        bbox_dir = "dataset/Kitti/kitti_raw_data_flow/bbox"
        sem_dir = "dataset/Kitti/kitti_raw_data_flow/sem"
        ins_dir = "dataset/Kitti/kitti_raw_data_flow/ins"
        input_dir = "dataset/Kitti/kitti_raw_data_flow/img"
        img_ext = "png"
    else:
        # kitti dataset
        bbox_dir = "dataset/Kitti/data_scene_flow_SIG/bbox"
        sem_dir = "dataset/Kitti/data_scene_flow_SIG/sem"
        ins_dir = "dataset/Kitti/data_scene_flow_SIG/ins"
        input_dir = "dataset/Kitti/data_scene_flow/training/image_2"
        img_ext = "png"
