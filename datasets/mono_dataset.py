...
class MonoDataset(data.Dataset):
    ...
    def __init__(self,
        ...
        if self.opt.SIG or self.opt.instance_pose :
            ...
            # self.data_sem_path = os.path.join(self.opt.project_dir, "dataset", "kitti_data_sem_"+self.opt.split, self.mode)
            '''
            self.data_ins_path = os.path.join(self.opt.project_dir, "dataset", "kitti_data_ins_"+self.opt.split, self.mode)
            self.data_bbox_path = os.path.join(self.opt.project_dir, "dataset", "kitti_data_bbox_"+self.opt.split, self.mode)
            self.data_sem_path = os.path.join(self.opt.project_dir, "dataset", "kitti_data_sem_eigen_zhou", self.mode)
            '''
            self.data_ins_path = os.path.join(self.opt.data_path.replace("raw_data", "kitti_data_ins_"+self.opt.split), self.mode)
            self.data_bbox_path = os.path.join(self.opt.data_path.replace("raw_data", "kitti_data_bbox_"+self.opt.split), self.mode)
            self.data_sem_path = os.path.join(self.opt.data_path.replace("raw_data", "kitti_data_sem_eigen_zhou"), self.mode)
