...
for MODEL in 'stage123v2_monoori_woSIG_srcsample2_inverse' 'stage123v2_monoori_woSIG_srcsample2_wofgmask_inverse'
do
    mkdir ${OUTDIR}/${MODEL}
    for EPOCH in {1..1..-1}
    do
        # step1: compute flow
        CUDA_VISIBLE_DEVICES=${CUDAIDX} python3 compute_flow_with_ins_flow4_inverse_vis.py \
