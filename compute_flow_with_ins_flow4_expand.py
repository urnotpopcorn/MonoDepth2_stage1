        ...
        for bs_idx in range(mask.shape[0]):
            ...
            if horizontal_indicies.shape[0]:
                ...
                if self.opt.ext_recept_field:
                    x1 = x1 - 30 if x1 >= 30 else 0
                    y1 = y1 - 30 if y1 >= 30 else 0
                    x2 = x2 + 30 if x2 < (self.opt.width - 30) else (self.opt.width-1)
                    y2 = y2 + 30 if y2 < (self.opt.height - 30) else (self.opt.height-1)
