...
if __name__ == "__main__":
    ...
    kitti_data_bbox_dir = os.path.join(base_dir, "dataset", "kitti_data_bbox_geonet_flow")
    make_dir(kitti_data_bbox_dir)

    extra_train_lines = get_extra_lines(kitti_data_dir, kitti_data_bbox_dir, train_lines, mode="train")
    extra_val_lines = get_extra_lines(kitti_data_dir, kitti_data_bbox_dir, val_lines, mode="val")
    ...
    print("inference val")
    inference(predictor, kitti_data_dir, kitti_data_bbox_dir, extra_val_lines, mode="val")
    print("inference train")
    inference(predictor, kitti_data_dir, kitti_data_bbox_dir, extra_train_lines, mode="train")
