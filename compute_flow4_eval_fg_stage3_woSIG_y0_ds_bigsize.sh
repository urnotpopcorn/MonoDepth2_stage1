...
for MODEL in 'stage123v2_monoori_woSIG_srcsample2_roi_y0_ds'
do
    mkdir ${OUTDIR}/${MODEL}
    for EPOCH in {19..19..-1}
    do
        # step1: compute flow
        CUDA_VISIBLE_DEVICES=${CUDAIDX} python3 compute_flow_with_ins_flow4_y0_ds.py \
