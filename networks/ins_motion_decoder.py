...
class InsMotionDecoder(nn.Module):
    def __init__(self, num_ch_enc, num_input_features, 
                    num_frames_to_predict_for=None, stride=1, 
                    num_output_channels=1, num_RoI_cat_features=1024):
        super(InsMotionDecoder, self).__init__()
        '''
    ...
    def forward(self, RoI_feature):
        ...
        return delta_x_inv, delta_y_inv, delta_z_inv
